...
export default function ListReviews(props) {
    ...
    useEffect(() => {
        db.collection('reviews')
            .where('isRestaurant', '==', idRestaurant)
            .get()
            .then((response) => {
                const resultReview = [];
        ...
        <View>
            {userLogged ? (
                ...
                <View>
                    ...
                    >
                        Para escribir comentario debes logearte{" "}
                        <Text style={{fontWeight: 'bold'}}>Pulsa AQUI para iniciar sesion</Text>
                    </Text>
                </View>
            )}
...
function Review(props) {
    ...
    return (
        <View style={styles.viewReview}>
            <View style={styles.viewImgeAvatar}>
                <Avatar
                    size='large'
                    rounded
